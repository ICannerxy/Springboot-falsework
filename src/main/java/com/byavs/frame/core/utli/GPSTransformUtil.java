 ...
 * <p>
 * Created by zemo.wang on 2018/8/24.
 */
public class GPSTransformUtil {
    ...
    /**
     * Mars to BD09：火星坐标系 to 百度坐标系
     *
     * @param glat
     * @param glon
     * @return
     */
    public static double[] marsToBD09(double glat, double glon) {
        double x = glon;
        double y = glat;
    ...
    /**
     * BD09 to Mars：百度坐标系 to 火星坐标系
     *
     * @param glat
     * @param glon
     * @return
     */
    public static double[] bd09ToMars(double glat, double glon) {
    ...
    /**
     * BD09 to Earth：百度坐标系 to 地球坐标系
     *
     * @param glat
     * @param glon
     * @return
     */
    public static double[] bd09ToEarth(double glat, double glon) {
        double[] latlon = bd09ToMars(glat, glon);
        return marsToEarth(latlon[0], latlon[1]);
    }

    /**
     * Earth to BD09：地球坐标系 to 百度坐标系
     *
     * @param wgLat
     * @param wgLon
     * @return
     */
    public static double[] earthToBD09(double wgLat, double wgLon) {
        double[] latlon = earthToMars(wgLat, wgLon);
        return marsToBD09(latlon[0], latlon[1]);
    }

    /**
     * Earth to Mars：地球坐标系 to 火星坐标系
     *
     * @param wgLat
     * @param wgLon
     * @return
     */
    public static double[] earthToMars(double wgLat, double wgLon) {
        double[] latlon = new double[2];
    ...
    /**
     * Mars to Earth：火星坐标系 to 地球坐标系(粗略)
     *
     * @param glat
     * @param glon
     * @return
     */
    //
    public static double[] marsToEarth(double glat, double glon) {
        double[] latlon = new double[2];
    ...
    /**
     * Mars to Earth：火星坐标系 to 地球坐标系（精确）
     *
     * @param gcjLat
     * @param gcjLon
     * @return
     */
    public static double[] marsToEarthExactly(double gcjLat, double gcjLon) {
        ...
        while (true) {
            wgsLat = (mLat + pLat) / 2;
            wgsLon = (mLon + pLon) / 2;
            double[] tmp = earthToMars(wgsLat, wgsLon);
            dLat = tmp[0] - gcjLat;
            dLon = tmp[1] - gcjLon;
